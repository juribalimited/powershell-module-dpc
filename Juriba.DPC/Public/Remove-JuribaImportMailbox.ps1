#Requires -Version 7
function Remove-JuribaImportMailbox {
    [alias("Remove-DwImportMailbox")]
    <#
        .SYNOPSIS
        ...
        .EXAMPLE
        PS> Remove-JuribaImportMailbox -ImportId 1 -UniqueIdentifier "w123abc" -Instance "https://myinstance.dashworks.app:8443" -APIKey "xxxxx"
