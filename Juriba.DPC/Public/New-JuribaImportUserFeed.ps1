#requires -Version 7
function New-JuribaImportUserFeed {
    [alias("New-DwImportUserFeed")]
    <#
        .SYNOPSIS
        ...
        PS> New-JuribaImportUserFeed -Name "My New Import" -Instance "myinstance.dashworks.app" -APIKey "xxxxx"
