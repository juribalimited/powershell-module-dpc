#requires -Version 7
function New-JuribaImportLocationFeed {
    [alias("New-DwImportLocationFeed")]
    <#
        .SYNOPSIS
        ...
        PS> New-JuribaImportLocationFeed -Name "My New Import" -Instance "myinstance.dashworks.app" -APIKey "xxxxx"
