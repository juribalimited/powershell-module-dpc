function New-JuribaCapacitySlot {
    [alias("New-DwCapacitySlot")]
    <#
        .SYNOPSIS
        ...
        SlotId.
        .EXAMPLE
        PS> New-JuribaCapacitySlot -Instance "https://myinstance.dashworks.app:8443" -APIKey "xxxxx" -ProjectID 1 -SlotName "W11 Deployment Slot" -DisplayName "Mon - Fri" -CapacityType "Capacity Units" 
    ...
    if ($APIKey -and $Instance) {
        ...
        $uri = "{0}/apiv1/admin/projects/{1}/createCapacitySlot" -f $Instance, $ProjectID
        ...
        if ($PSCmdlet.ShouldProcess($Name)) {
            ...
            return ($result.Content | ConvertFrom-Json).id
        }
    }
    else {
