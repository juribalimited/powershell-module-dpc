...
.SYNOPSIS
A sample script to query the MECM database for Add/Remove Programs Applications and related devices and import
...
$table = Invoke-Sqlcmd @MecmParams -InputFile "$PSScriptRoot\MECM ARP Application to Device Query.sql"
