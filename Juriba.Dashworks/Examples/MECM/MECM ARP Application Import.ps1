...
.SYNOPSIS
A sample script to query the MECM database for Add/Remove Programs Applications and import
...
$table = Invoke-Sqlcmd @MecmParams -InputFile "$PSScriptRoot\MECM ARP Application Query.sql"
