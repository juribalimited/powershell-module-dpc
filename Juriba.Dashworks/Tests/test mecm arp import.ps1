...
& '.\Juriba.Dashworks\Examples\MECM\MECM ARP Application Import.ps1' @scriptparams


& '.\Juriba.Dashworks\Examples\MECM\MECM ARP Application to Device Import.ps1' @scriptparams
