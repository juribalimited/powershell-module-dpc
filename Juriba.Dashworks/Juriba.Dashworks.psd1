#
# Module manifest for module 'Juriba.Dashworks'
#
# Generated by: Juriba
#
...
@{
    ...
    FunctionsToExport = @('Get-AuthSession', 'Export-EvergreenList', 'New-CustomField', 'Get-DashworksDevice', 'New-DashworksDevice', 'Set-DashworksDevice', 'Remove-DashworksDevice')
