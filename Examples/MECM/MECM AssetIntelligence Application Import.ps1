...
.SYNOPSIS
A sample script to query the MECM database for Asset Intelligence Applications and import
those applications into Dashworks.

.DESCRIPTION
A sample script to query the MECM database for Asset Intelligence Applications and import
those applications into Dashworks. Script will either update or create the applications.
...
$table = Invoke-Sqlcmd @MecmParams -InputFile "$PSScriptRoot\MECM AssetIntelligence Application Query.sql"
