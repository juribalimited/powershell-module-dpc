...
.SYNOPSIS
A sample script to query the MECM database for Applications and related devices and import
...
$table = Invoke-Sqlcmd @MecmParams -InputFile "$PSScriptRoot\MECM App Application to Device Query.sql"
