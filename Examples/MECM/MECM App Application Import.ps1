...
$table = Invoke-Sqlcmd @MecmParams -InputFile "$PSScriptRoot\MECM App Application Query.sql"
...
foreach ($row in $table){
    ...
    $jsonBody = $row | Select-Object * -ExcludeProperty ItemArray, Table, RowError, RowState, HasErrors | ConvertTo-Json -EscapeHandling EscapeNonAscii
